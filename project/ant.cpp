...
void ant::push_new_pos(pheromone& phen, const labyrinthe& laby, const position_t& pos_food, const position_t& pos_nest,
                   std::size_t& cpteur_food, position_t new_pos_ant)
{
    if ( is_loaded( ) ) {
